...
public class AuthorizationServiceDiscovery {
    ...
    @VisibleForTesting
    static final JsonUtil.UriField AUTHORIZATION_ENDPOINT = uri("authorization_endpoint");

    @VisibleForTesting
    static final JsonUtil.UriField TOKEN_ENDPOINT = uri("token_endpoint");

    @VisibleForTesting
    static final JsonUtil.UriField END_SESSION_ENDPOINT = uri("end_session_endpoint");

    @VisibleForTesting
    static final JsonUtil.UriField USERINFO_ENDPOINT = uri("userinfo_endpoint");

    @VisibleForTesting
    static final JsonUtil.UriField JWKS_URI = uri("jwks_uri");
    ...
    @VisibleForTesting
    static final JsonUtil.StringListField RESPONSE_TYPES_SUPPORTED = strList("response_types_supported");
    ...
    @VisibleForTesting
    static final JsonUtil.StringListField SUBJECT_TYPES_SUPPORTED = strList("subject_types_supported");
