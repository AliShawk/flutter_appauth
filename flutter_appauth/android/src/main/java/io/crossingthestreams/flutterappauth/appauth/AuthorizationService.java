...
import io.crossingthestreams.flutterappauth.appauth.browser.BrowserDescriptor;
import io.crossingthestreams.flutterappauth.appauth.browser.BrowserSelector;
import io.crossingthestreams.flutterappauth.appauth.browser.CustomTabManager;
import io.crossingthestreams.flutterappauth.appauth.connectivity.ConnectionBuilder;
import io.crossingthestreams.flutterappauth.appauth.internal.Logger;
...
public class AuthorizationService {
     ...
     * activity is paused or destroyed (i.e. in {@link Activity#()}).
     */
    public void dispose() {
        if (mDisposed) {
            return;
